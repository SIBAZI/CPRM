globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://C:/CPRM/CPRM/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, readBody, getQuery as getQuery$1, createError } from 'file://C:/CPRM/CPRM/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file://C:/CPRM/CPRM/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/CPRM/CPRM/node_modules/devalue/index.js';
...
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://C:/CPRM/CPRM/node_modules/ufo/dist/index.mjs';
...
const _lazy_lpj1cC = () => Promise.resolve().then(function () { return contract_get$1; });
const _lazy_gjdPia = () => Promise.resolve().then(function () { return contract_post$1; });
const _lazy_96JX17 = () => Promise.resolve().then(function () { return users_get$1; });
const _lazy_mfqIin = () => Promise.resolve().then(function () { return users_post$1; });
const _lazy_SS8gtd = () => Promise.resolve().then(function () { return renderer$1; });
...
const handlers = [
  ...
  { route: '/__nuxt_error', handler: _lazy_SS8gtd, lazy: true, middleware: false, method: undefined },
...
const contract_get$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: contract_get
});
...
const contract_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
...
const getClientManifest = () => import('file://C:/CPRM/CPRM/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
