...
<template>
  <div>
    ...
    <v-row>
      <v-toolbar-title
        class="ml-15 normalCarDocuments"
    ...
    <v-row>
      <v-toolbar-title
        class="ml-15 normalCarDocumentsGarageVerification"
        v-if="
          this.normalCarDocuments.poaOssKubun === '委任状' ||
    ...
    <v-row>
      <v-toolbar-title
        class="ml-15 lightCarDocumentsGarageVerification"
        v-if="
    ...
    <v-row>
      <v-toolbar-title class="ml-15"> ▼メモ </v-toolbar-title>
    </v-row>
    ...
    <v-row class="mt-5">
      <v-col cols="1" class="mx-10">
        <v-btn @click="onSave" size="large" variant="outlined"> 保存 </v-btn>
      </v-col>
    </v-row>
  </div>
</template>
